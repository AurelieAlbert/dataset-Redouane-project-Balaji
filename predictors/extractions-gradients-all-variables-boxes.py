...
def compute_all_profiles(var,date,ibox,imin,imax,jmin,jmax,box_name):
    ...
    e1=dsgrid[str(filee1[var])][0,jmin[ibox]-10:jmax[ibox]+10,imin[ibox]-10:imax[ibox]+10]
    e2=dsgrid[str(filee2[var])][0,jmin[ibox]-10:jmax[ibox]+10,imin[ibox]-10:imax[ibox]+10]
    e3=dsgrid[str(filee3[var])][0,jmin[ibox]-10:jmax[ibox]+10,imin[ibox]-10:imax[ibox]+10]
